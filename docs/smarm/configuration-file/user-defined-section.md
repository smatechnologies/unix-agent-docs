---
title: USER_DEFINED Section
description: "Reference for the SMA_RM USER_DEFINED section, which allows custom scripts or programs to report normal/alarm status and return loggable values during each scan cycle."
tags:
  - Reference
